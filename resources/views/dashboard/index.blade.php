                        ...
                        <div class="col-xl-4 col-md-6 col-12">
                            <div class="card card-congratulation-medal">
                                <div class="card-body">
                                    ...
                                    <img src="{{ asset('dashboard_files/app-assets/images/illustration/badge.svg') }}" class="congratulation-medal" alt="Medal Pic" />
                                </div>
                            </div>
                        </div>
                        <!--/ Medal Card -->
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('dashboard_files/app-assets/images/illustration/badge.svg') }}" alt="Toolbar svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('dashboard_files/app-assets/images/icons/parachute.svg') }}" alt="Parachute svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('dashboard_files/app-assets/images/icons/brush.svg') }}" alt="Brush svg" />
                                                            </div>
                                                        </div>
                                                        <div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar rounded">
                                                            <div class="avatar-content">
                                                                <img src="{{ asset('dashboard_files/') }}" alt="Star svg" />
                                                            </div>
                                                        </div>
                                                        <div>
